  ...
  return (
    <div r className={`mt-40 mx-auto w-2/3 sm:w-2/3 md:w-2/3 xl:w-1/2 2xl:w-1/2 scroll-animate ${cl}`}>
      ...
      <p
        className={
          localStorage.getItem("theme") == "dark"
            ? "font-bold text-2xl text-center mt-5 mb-5 text-gray-600"
            : "font-bold text-2xl text-center mt-5 mb-5"
        }
      >
        Siddharth Pareek 👋≧◉ᴥ◉≦
      </p>
      <div className="flex-wrap w-72 sm:w-72 md:w-80 xl:w-80 2xl:w-80 mx-auto mt-10 mb-10 flex justify-around">
        <div className="mt-2 w-20 h-6 bg-red-400 text-white  rounded-md font-bold text-center text-sm">
          Frontend
        </div>
      ...
      <p
        className={
          localStorage.getItem("theme") == "dark"
            ? "text-white  selection:text-orange-400 text-justify"
            : "text-black  selection:text-orange-400 text-justify"
        }
      >
        ...
        (̶◉͛‿◉̶) a FRONTEND DEVLOPER with proficiency in{" "}
        ...
        . I like to develop websites and moreover I like to make them
      ...
      <p
        className={
          localStorage.getItem("theme") == "dark"
            ? "text-white mt-20 mb-10  selection:text-orange-400"
            : "text-black mt-20 mb-10  selection:text-orange-400"
        }
      >
        Feel free to <span className="text-blue-600">🄲🄾🄽🄽🄴🄲🅃</span> with me via{" "}
        <span className="font-bold text-2xl text-red-500">Gmail </span>
        <a href="" className="text-blue-600">
          siddharth2000pareek@gmail.com
        </a>{" "}
        ,<span className="font-bold text-2xl text-blue-500">LinkedIn</span>{" "}
        <a
        ...
        and <span className="text-green-600 font-bold text-2xl">☏ </span>{" "}
        <span className="text-purple-600">+91 7987067945.</span>
      </p>
      <p
        className={
          localStorage.getItem("theme") == "dark"
            ? "text-white  selection:text-orange-400 text-center mt-10 mb-10"
      ...
      <a
        className=" selection:text-orange-400 block hover:text-blue-400 mt-10 mb-40 text-center font-bold bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent"
        href="https://www.linkedin.com/in/siddharth-pareek-75514b190/"
        target="_blank"
      >
        Siddharth Pareek
